    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.arrow_back, color: Colors.white), // Icono blanco para contraste
        ),
      ),
      body: Container(
        padding: const EdgeInsets.all(16.0), // Aumentar el padding para mejor espaciado
        child: ListView(
          children: [
            ...
            _buildDetailTile("Correo Electrónico", correo_electronico, Icons.email),
