          ...
          child: ListView(
            children: [
              ...
              MyTextField(
                ...
                prefixIconColor: Colors.deepPurple.shade300,
                keyboardType: TextInputType.emailAddress, // Set keyboard to email
                validator: (value) {
                  if (value == null || value.isEmpty) {
  ...
  OutlinedButton _buildSubmitButton(BuildContext context) {
    return OutlinedButton(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(color: Colors.deepPurple.shade300, width: 2), // Add border
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        border: const OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(10)), // Rounded corners for border
        ),
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(color: Colors.grey.shade400), // Lighter border when not focused
          borderRadius: const BorderRadius.all(Radius.circular(10)),
        ),
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: Colors.deepPurple.shade300, width: 2), // Thicker border when focused
          borderRadius: const BorderRadius.all(Radius.circular(10)),
        ),
        labelStyle: const TextStyle(color: Colors.deepPurple),
        floatingLabelStyle: TextStyle(color: Colors.deepPurple.shade500, fontSize: 18), // Style for floating label
        hintStyle: TextStyle(color: Colors.grey.shade500),
        errorStyle: const TextStyle(color: Colors.redAccent, fontSize: 13), // Style for error text
      ),
    );
  }
}
